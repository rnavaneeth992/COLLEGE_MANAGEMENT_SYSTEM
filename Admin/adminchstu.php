...
<html lang="en">
  <head>
    ...
    <!-- Required meta tags -->
    <link rel="stylesheet" href="adminchstustyle.css">
    <meta charset="utf-8">
  ...
  <body class="bg">
    ...
    <?php
      ...
      $conn = mysqli_connect($servername, $username, $password, $dbname);
        ...
        $sql="SELECT * FROM project1.students WHERE UID='$lecid'";
      ...
      ?>
      <center>
      <form action="adminupstu.php" method="POST">
        <div class="outline">
       <label class="detail"> Name : </label><input type="text" name="Name" value="<?php echo $name;?>" class="txt"><br><br>
       <label class="detail"> Department : </label><input type="text" name="Department" value="<?php echo $dep;?>" class="txt" ><br><br>
      <label class="detail"> number : </label><input type="text" name="Phno" value="<?php echo $phno;?>" class="txt"><br><br>
        <label class="detail">Year : </label><input type="text" name="Year" value="<?php echo $year;?>" class="txt"><br><br>
        <label class="detail">Email : </label><input type="text" name="Email" value="<?php echo $email;?>" class="txt"><br><br>
