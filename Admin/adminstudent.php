...
<html lang="en">
  <head>
    ...
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <link rel="stylesheet" href="adminstudentstyle.css">
  ...
  <body class="bg">
    ...
    ?>
      <center>
          <label class="title2">Students Details Modifying</label>
          <form action="adminchstu.php" method="POST">
           
          <marquee scrollamount=10 class="detail">To change students details</marquee><br>
          <div class="outline">
          <label class="detail1">  Enter their ID</label><br>
          <label class="detail1">ID No : </label> <input type="text" name="id"><br><br> 
          <input type="submit" value="Submit" class="btn-grad">
  </div>  
        </form>
          <hr>
          <label class="title2">Students Results</label>
          <form action="adminrech.php" method="POST">
            
          <marquee scrollamount=10 class="detail"> Add or change student result </marquee><br>
          <div class="outline"
          ><label class="detail1">Enter their ID</label><br>
          <label class="detail1">ID No : </label><input type="text" name="id"><br><br> 
          <input type="submit" value="Submit" class="btn-grad">
