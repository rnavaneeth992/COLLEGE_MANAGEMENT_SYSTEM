...
<html lang="en">
  <head>
    ...
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <link rel="stylesheet" href="adminupstustyle.css">
  ...
  <body class="bg">
    ...
    <?php
        ...
        $conn = mysqli_connect($servername, $username, $password, $dbname);
            ...
            $sql="UPDATE project1.students SET name='$name', Department='$dep',Year='$year',Email='$email',Phno='$phno'
            WHERE UID='$lecid'";
            if (mysqli_query($conn, $sql)) {
                echo "<center><label class='title1'>Record updated successfully</label></center>";
              } else {
                echo "<label class='title1'>Error updating record: </label>" . mysqli_error($conn);
              }
      ?>
    <!-- Optional JavaScript -->
