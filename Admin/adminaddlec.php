...
<html lang="en">
  <head>
    ...
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <link rel="stylesheet" href="adminaddlecstyle.css">
  ...
  <body class="bg">
    ...
    <form action="" method="POST">
      <div class="outline">
    <label class="detail1"> ID:</label><input type="text" name="ID" class="txt"><br><br>
    <label class="detail1">Name:</label><input type="text" name="Name"  class="txt"><br><br>
    <label class="detail1">Phno:</label><input type="text" name="Phno"  class="txt"><br><br>
    <label class="detail1">Email:</label><input type="text" name="Email"  class="txt"><br><br>
    <label class="detail1">1) Positions    :</label><select name="Position" class="btn btn-success float-right">
                                    ...
                                    <br>
                                    <br>
    <label class="detail1">2) Department : </label><select name="Department" class="btn btn-success float-right">
    ...
    <input type="submit" value="Submit" class="btn-grad">
      ...
      <?php
      if(isset($_POST['Name'])&&isset($_POST['ID'])&&isset($_POST['Phno'])&&isset($_POST['Email']))
      {
        include 'include.php';
        $name=$_POST["Name"];
        ...
        $conn = mysqli_connect($servername, $username, $password, $dbname);
            ...
            $sql="INSERT INTO project1.lecturer (ID, Name, Department, Position, Phno, Email)
            VALUES ('$id', '$name', '$dep', '$pos', '$phno','$email');";
            if (mysqli_query($conn, $sql)) {
                echo "<center><label name='title'>Record updated successfully</label></center>";
              } else {
                echo "<label class='title2'><center>Error updating record:</label><br> " . mysqli_error($conn);
              }
      }
      else{
      }
