...
<div class="container-fluid">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
      ...
      <li class="nav-item">
        <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Results</a>
      </li>
      <li class="nav-item">
...
<center>
    ...
    $conn = mysqli_connect($servername, $username, $password, $dbname);
      ...
      if (mysqli_num_rows($result)>0) {
        echo '<h3>1st Semester</h3>';
        while($row = mysqli_fetch_assoc($result)) {
            echo '<table border="5" class="table table-success table-hover">';
            echo '<tr>';
            echo '<td>Technical English</td>';
            echo '<td>'.$row["HS6151"].'</td>';
            echo '<tr>';
            echo '<tr>';
            echo '<td>Physics</td>';
            echo '<td>'.$row["PH6151"].'</td>';
            echo '<tr>';
            echo '<tr>';
            echo '<td>Maths</td>';
            echo '<td>'.$row["MA6151"].'</td>';
            echo '<tr>';
            echo '<tr>';
            echo '<td>Programming with C</td>';
            echo '<td>'.$row["CS6101"].'</td>';
            echo '<tr>';
            echo '<tr>';
            echo '<td>Computational Thinking</td>';
            echo '<td>'.$row["CS6102"].'</td>';
            echo '<tr>';
            echo '</table>';
        }
      }
    ...
    <br>
    <button class="btn-grad" onclick="red()">Download marks</button> 


    <script>
      function red(){
        window.location.href="resultspdf.php"
      }
